...
CAMLprim value stub_get_blktap3_stats(value filename)
{
	...
	Store_field(stats, 0, caml_copy_int64((int64) c_stats.st_rd_sect));
	...
	Store_field(stats, 3, caml_copy_int64((int64) c_stats.st_wr_sect));
	...
	Store_field(stats, 6, caml_copy_int64((int64) c_stats.st_rd_req));
	Store_field(stats, 7, caml_copy_int64((int64) c_stats.st_wr_req));
